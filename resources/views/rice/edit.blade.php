                    ...
                    <form action="{{ route('rices.update', $rice) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="rice_name" id="rice_name"
                                ...
                                <option value="Jasmine" {{ old('rice_name', $rice->rice_name) == 'Jasmine' ? 'selected' : '' }}>Jasmine</option>
                                <option value="Brown" {{ old('rice_name',  $rice->rice_name) == 'Brown' ? 'selected' : '' }}>Brown</option>
                                <option value="Dinorado" {{ old('rice_name',  $rice->rice_name) == 'Dinorado' ? 'selected' : '' }}>Dinorado</option>
                            </select>
                            @error('rice_name')
